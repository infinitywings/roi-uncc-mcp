...
class MCPServer:
    ...
    def _load_config(self, config_path):
        ...
        if config_path is None:
            ...
            possible_paths = [
                '/app/mcp-server/config/mcp.yaml',
                'mcp-server/config/mcp.yaml',
                'config/mcp.yaml',
                os.path.join(os.path.dirname(os.path.dirname(__file__)), 'config', 'mcp.yaml')
            ]
    ...
    def initialize_federation(self):
        ...
        try:
            ...
            # Initialize threat validator - find config directory
            possible_config_dirs = [
                '/app/mcp-server/config',
                'mcp-server/config',
                'config',
...
def main():
    """Main entry point"""
    try:
        server = MCPServer()  # Let it auto-detect config path
        server.start()
